...
namespace Diceomancer.Scripts.Hero.Builder;

[RegisterCharacter]
public class
    Builder : ModCharacterTemplate<BuilderCardPool, BuilderRelicPool, BuilderPotionPool>
{
    // 角色名称颜色
    ...
    public override CharacterAssetProfile AssetProfile => CharacterAssetProfiles.Merge(
        ...
        new CharacterAssetProfile(
            ...
            new CharacterUiAssetSet(
                // 人物头像(图鉴)。
                IconTexturePath: "res://Diceomancer/images/Hero/BuilderIcon.png",
                // 人物头像(地图)。
                ...
                // 人物选择图标-锁定状态。
                CharacterSelectLockedIconPath: "res://Diceomancer/images/Hero/Builder.png"
                // 人物选择过渡动画。
