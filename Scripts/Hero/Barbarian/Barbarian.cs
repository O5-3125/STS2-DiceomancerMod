...
namespace Diceomancer.Scripts.Hero.Barbarian;

[RegisterCharacter]
public class
    Barbarian : ModCharacterTemplate<BarbarianCardPool, BarbarianRelicPool, BarbarianPotionPool>
{
    // 角色名称颜色
    ...
    public override CharacterAssetProfile AssetProfile => CharacterAssetProfiles.Merge(
        ...
        new CharacterAssetProfile(
            ...
            new CharacterUiAssetSet(
                // 人物头像(图鉴)。
                IconTexturePath: "res://Diceomancer/images/Hero/BarbarianIcon.png",
                // 人物头像(地图)。
                IconPath: "res://Diceomancer/scenes/Heros/HeroIcon.tscn",
                // 人物选择背景。
                CharacterSelectBgPath: "res://Diceomancer/scenes/Heros/Barbarian_bg.tscn",
                // 人物选择图标。
                CharacterSelectIconPath: "res://Diceomancer/images/Hero/Barbarian.png",
                // 人物选择图标-锁定状态。
                CharacterSelectLockedIconPath: "res://Diceomancer/images/Hero/Barbarian.png"
                // 人物选择过渡动画。
