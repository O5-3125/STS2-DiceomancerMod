    ...
    : ModCardTemplate(1, CardType.Skill, CardRarity.Token, TargetType.Self)
{
    ...
    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
    {
        ...
        var capability = ModelCapabilityRegistry.Create<RandomBuffCapability>();
        capability.DynamicVars["Buff"].BaseValue = DynamicVars["modify"].IntValue;
        cardModel?.AddCapability(capability);
        
        // cardModel?.GetOrCreateCapability<RandomBuffCapability>(); // 挂载组件
    }
