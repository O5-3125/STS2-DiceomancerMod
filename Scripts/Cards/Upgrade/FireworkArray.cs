    ...
    : ModCardTemplate(2, CardType.Power, CardRarity.Rare, TargetType.Self)
{
    ...
    {
        await PowerCmd.Apply<FireworkArrayPower>(choiceContext, Owner.Creature,
            DynamicVars["FireworkArrayPower"].IntValue, Owner.Creature, this);
    }

    protected override void OnUpgrade()
    {
        DynamicVars["FireworkArrayPower"].UpgradeValueBy(1);
    }
}